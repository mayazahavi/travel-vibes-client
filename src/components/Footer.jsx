        ...
        <div className={styles.grid}>
          <div className={styles.column}>
            ...
            <p className={styles.brandDesc}>
              Curating unforgettable travel experiences based on your personal
              vibe. Find your rhythm in the world.
            </p>
          </div>
          <div className={styles.column}>
            ...
            <ul className={styles.linkList}>
              <li className={styles.linkItem}>
                <Link to="/vibes" className={styles.link}>
                  Vibes
                </Link>
              </li>
              <li className={styles.linkItem}>
              ...
              <li className={styles.linkItem}>
                <Link to="/create-trip" className={styles.link}>
                  Plan a Trip
                </Link>
              </li>
              <li className={styles.linkItem}>
                <Link to="/my-trips" className={styles.link}>
                  My Trips
                </Link>
              </li>
            </ul>
