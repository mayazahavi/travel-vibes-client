      ...
      <div className={styles.pageContainer}>
        <div className={styles.createTripCard}>
          <div className={styles.imageSide}>
            <img src={getCurrentImage()} alt="Travel Vibe" className={styles.vibeImage} />
          ...
          <div className={styles.formSide}>
            <ProgressBar steps={steps} currentStep={currentStep} styles={styles} />
            ...
            <div className={styles.navigationButtons}>
              ...
              <button type="button" onClick={nextStep} className={`button is-primary ${styles.nextButton}`} style={{ marginLeft: currentStep === 1 ? 'auto' : '0' }}>
