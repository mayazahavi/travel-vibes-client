    ...
    <div className={styles.favoritesPage}>
      ...
      >
        ...
        <h1
          ...
          style={{ marginBottom: "5px", color: "#000000", fontSize: "2rem" }}
        >
          ...
          <div className="columns is-gapless mb-0">
            ...
            >
              <div style={{ padding: "30px" }}>
                ...
                >
                  <h3
                    className="title is-6 is-uppercase mb-0"
                    style={{
                      letterSpacing: "1px",
                      fontSize: "0.8rem",
                      color: "#0f172a",
                ...
                >
                  {days.map((day) => (
                    <button
                      ...
                      style={{
                        border:
                          selectedDay === day ? "none" : "1px solid #e2e8f0",
                        fontWeight: "600",
                        padding: "0 20px",
                        height: "36px",
                        boxShadow:
                      ...
                      >
                        ...
                        <div
                          style={{
                            ...
                            top: "0",
                            bottom:
                              index === dayPlaces.length - 1 ? "auto" : "-30px",
                            width: "2px",
                            background: "#e2e8f0",
                          }}
                        ></div>
                        ...
                        >
                          ...
                          >
                            <input
                              ...
                              onChange={(e) =>
                                updatePlaceTime(place.id, e.target.value)
                              }
                              style={{
                                border: "none",
                                outline: "none",
